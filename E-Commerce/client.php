			...
			<section class="main-content">				
				<?php if($_SESSION['login']=='admin')  {?>
					<table class="table table-striped table-bordered"> 
						...
						$imageProduit = $item["imageProduitContentType"];  ?>
							<tr>
								<td><?php echo $idProduit; ?></td>
								<td><?php echo $nomProduit; ?></td>
								<td><?php echo $descriptionProduit; ?></td>
								<td><img alt="" src="images/<?php echo $imageProduit; ?>" width="50%" style="height: 30px !important;"></td>
								<td style="width: 18%;">
								    <a href="traitement/supprimerProduit.php?idProduit=<?php echo $idProduit ; ?>" >
					  ...
					  <div class="pagination pagination-small pagination-centered">
							<ul>
								<li class="active <?= ($currentPage == 1) ? "disabled" : "" ?>">
									<a href="client.php?page=<?= $currentPage - 1 ?>">Prev</a>
								</li>
								<?php for ($page = 1; $page <= $pages; $page++) : ?>
									<li class="<?= ($page == $currentPage) ? "active" : "" ?>">
										<a href="client.php?page=<?= $page ?>"><?= $page ?></a>
									</li>
								<?php endfor ?>
								<li class="<?= ($currentPage == $pages) ? "disabled" : "" ?>">
									<a href="client.php?page=<?= $currentPage + 1 ?>">Next</a>
								</li>
							</ul>
						</div>
